...
const mediaItems: MediaItem[] = [
  {
    title: "Success Story: Dil Foods Founder Arpita Aditi Valued at Rs 75 Crore, Featured in Shark Tank India",
    source: "NavBharat Times",
    date: "February 20, 2024",
    description: "How Dil Foods founder Arpita Aditi impressed Shark Tank India judges and secured a Rs 2 crore deal at Rs 75 crore valuation.",
    ...
    imageUrl: "/lovable-uploads/47be681e-832e-444c-884a-0fdf808a7a8e.png",
    category: "news"
  },
  {
    title: "Dil Foods Founder Arpita Aditi Strikes Rs 2 Crore Deal with Four Sharks on Shark Tank India Season 3",
    source: "The Weekend Leader",
    date: "February 17, 2024",
    description: "Dil Foods' success story on Shark Tank India Season 3, where founder Arpita Aditi secured investment from four Sharks.",
    ...
    imageUrl: "/lovable-uploads/1167e12a-5b3b-4f3b-9653-7cb0ed27b4f6.png",
    category: "news"
  },
  {
    title: "Shark Tank India Judges to Invest Rs 2 Crore in Dil Foods at Rs 75 Crore Valuation",
    source: "Indian Startup News",
    date: "February 15, 2024",
    description: "Details of the investment deal between Shark Tank India judges and Dil Foods, highlighting the company's impressive growth.",
    ...
    imageUrl: "/lovable-uploads/bc80abec-e3aa-4ad2-b7e3-4378634c4e7b.png",
    category: "news"
  },
  {
    ...
    date: "July 25, 2023",
    description: "Dil Foods has secured $2 million in funding to expand its virtual restaurant operations across India.",
    ...
    imageUrl: "/lovable-uploads/2ebe7a63-955a-4824-81db-3eadc37a6d6d.png",
    category: "press"
  },
  {
    title: "Exclusive Interview: How One Can Get More Benefit From Dil Foods Startup",
    source: "Jansatta",
    date: "February 23, 2024",
    description: "Shark Tank Season 3 participant Arpita Aditi shares insights on how customers and partners can benefit from the Dil Foods platform.",
    ...
    imageUrl: "/lovable-uploads/8c184d03-531e-4220-a71c-e1dd8d9706ab.png",
    category: "blogs"
  },
  {
    ...
    source: "Entrackr",
    date: "July 24, 2023",
    description: "Details about Dil Foods' successful pre-Series A funding round and the company's expansion plans.",
        ...
        <section className="bg-gradient-purple-red py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-white/90 max-w-3xl mx-auto">
              Stay updated with the latest news, blogs, and press releases about Dil Foods and our mission to transform the food industry
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-50 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Subscribe to our newsletter to receive the latest updates about Dil Foods
            </p>
            <div className="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
              ...
              />
              <Button className="bg-dil-purple hover:bg-dil-purple/90 text-white">
                Subscribe Now
              </Button>
            </div>
          </div>
