    ...
    <div className="min-h-screen bg-background aahar-page scroll-snap-container">
      ...
      <section id="menu" className="min-h-screen flex items-center bg-[#FFF8E7] overflow-hidden scroll-snap-section">
        <div className="container mx-auto px-6">
          ...
          <div className="flex justify-center mb-16">
            <div className="flex items-center gap-4 px-6 py-2 bg-gradient-to-r from-[#F4A460]/20 to-[#C85A3A]/20 backdrop-blur-sm rounded-xl border border-[#F4A460]/30 shadow-lg max-w-md w-full">
              <span className="text-[#3E2723] text-sm font-medium">Available only on</span>
              <div className="flex items-center gap-3 flex-1">
                <a
      ...
      <section id="brands" className="min-h-screen scroll-snap-section scroll-snap-align-start py-16 md:py-24"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header Section - Aahar Theme */}
          <div className="text-center mb-12 px-4">
            <div className="relative">
              {/* Background Decoration with Aahar colors */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 bg-gradient-to-r from-red-200 to-green-200 rounded-full blur-3xl opacity-40"></div>
              </div>
              
              <div className="relative">
                <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 font-display text-red-700">
                  Explore Our Other
                ...
                <p className="text-sm sm:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed mb-8 text-gray-700">
                  ...
                  <span className="font-semibold text-red-600"> passion</span> and 
          ...
          <div className="relative">
            ...
            <div className="flex gap-6 md:gap-8 overflow-x-auto scrollbar-hide pb-6 px-4">
              {[
                ...
                >
                  {/* Aahar-themed Card Design */}
                  <div className="w-64 sm:w-72 md:w-64 h-52 sm:h-56 md:h-64 bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-orange-100 overflow-hidden transition-all duration-300 hover:shadow-xl hover:-translate-y-2 group-hover:border-orange-300 relative">
                    
                    {/* Brand Color Strip - Aahar themed */}
                    <div 
                    ...
                    <div className="flex flex-col items-center justify-center h-full p-6">
                      ...
                      {/* Logo Container with Aahar glow */}
                      <div className="relative mb-4">
                        <div className="absolute -inset-4 rounded-3xl blur-lg opacity-0 group-hover:opacity-30 transition-all duration-500 bg-gradient-to-r from-red-400 to-green-400" />
                      ...
                      <div className="opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                        <div 
                          ...
                          style={{ 
                            background: `linear-gradient(135deg, #F44336, #4CAF50)` 
                          }}
                        >
                          <span>Explore</span>
                    ...
                    {/* Corner Accent - Aahar themed */}
                    <div className="absolute top-3 right-3 w-2 h-2 rounded-full opacity-50 group-hover:opacity-80 transition-all duration-300 bg-red-500" />
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div className="text-center mt-12 px-4">
            <div className="relative inline-block">
              <div className="absolute inset-0 rounded-2xl blur opacity-40 transition-opacity duration-300 bg-gradient-to-r from-red-600 to-green-600"></div>
              
              <Link
                to="/#brands"
                className="relative inline-flex items-center gap-4 px-10 py-5 bg-gradient-to-r from-red-600 to-green-600 text-white font-bold text-lg rounded-2xl transition-all duration-500 hover:shadow-2xl transform hover:scale-105 hover:-translate-y-2 group"
              >
