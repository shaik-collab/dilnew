...
import { Users, Clock, PackageCheck, Percent, BarChart2, Award, ShoppingBag, Calculator, Send } from 'lucide-react';
...
const RestaurantPartnership = () => {
  ...
  const calculateUtilization = () => {
    const { kitchenSize, totalStaff, operatingHours, currentOrders, prepTime } = kitchenData;
    ...
    const totalPotentialOrders = prepTime > 0 ? Math.floor((60 / prepTime) * totalManHours) : 0;
    const additionalOrders = totalPotentialOrders - currentOrders;
    const underutilizedPercent = totalPotentialOrders > 0 
      ? Math.round(((totalPotentialOrders - currentOrders) / totalPotentialOrders) * 100) 
      : 0;
    ...
    } else if (additionalOrders >= 50 && additionalOrders < 100 && kitchenSize >= 150 && kitchenSize < 500) {
  ...
  const advantageCards = [
    {
      ...
      description: "Fulfill Dil's delivery-only brand orders and earn 30-40% profit.",
    ...
    },
    {
      ...
      description: "Dil covers commissions, discounts, and marketing with clear PnL.",
  ...
  const testimonials = [
    {
      quote: "We've been with Dil Foods for 3 years. We earn additional profits and have now opened another outlet.",
      author: "Prabhat Kumar"
    },
    {
      quote: "We see Dil as business partners rather than just a revenue source. We learn from them every day.",
      author: "Monika"
    },
    {
      quote: "We run Dil Punjabi Daily, Bihari Bowl, and Bhole Ke Chole. Our orders have doubled!",
      author: "Vivek"
    },
    {
      quote: "I run 4 Dil brands from my home kitchen; I've gained good income and knowledge through this association.",
      author: "Chaitanya"
    }
  ];

  const brands = [
    { name: "Aahar", logo: "/lovable-uploads/55d6ad50-361d-42cd-b556-c283b2ee23e4.png" },
    { name: "Bihari Bowl", logo: "/lovable-uploads/1310a9da-ccbe-4fa6-bc06-51441a0872ba.png" },
    { name: "Khichdi Bar", logo: "/lovable-uploads/e4e94576-7f4a-4f0c-ac31-cb388323568b.png" },
    { name: "Bhole ke Chole", logo: "/lovable-uploads/cdf67c56-7bd7-4023-af81-bf258fe60fe3.png" },
    { name: "The Chaat Cult", logo: "/lovable-uploads/235a933c-2973-43db-8419-1bc689100f0a.png" },
    { name: "House Of Andhra", logo: "/lovable-uploads/b7f77f5d-c32a-4b73-9673-c4572c649bf4.png" },
    { name: "Dil Foods", logo: "/lovable-uploads/981bf596-8923-43ae-950d-88e254903acf.png" },
    { name: "Dil Punjabi Daily", logo: "/lovable-uploads/b743a878-95c1-4663-b49a-820eec6a6800.png" },
    { name: "Bowled Over", logo: "/lovable-uploads/fde1b960-d52b-4beb-bf58-bb7c457abca9.png" },
    { name: "Nagada", logo: "/lovable-uploads/1baa2440-41ee-47c5-8537-70989d99f512.png" }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="pt-28 pb-16 md:pt-36 md:pb-24 bg-gradient-purple-red text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto mb-8 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>
            Unlock the full potential of your kitchen and increase your revenue without additional infrastructure costs
          </p>
          <a 
            href="#signup" 
      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Easy 3-Step Onboarding</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-yellow-orange rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-dil-purple mb-3">Pick the Brand Concept</h3>
                <p className="text-dil-purple mb-4">Choose from our portfolio of virtual brands that best suit your kitchen.</p>
            ...
            <div className="bg-gradient-yellow-orange rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-dil-purple mb-3">Get Your Staff Trained</h3>
                <p className="text-dil-purple mb-4">Our experts will train your kitchen staff at no additional cost.</p>
            ...
            <div className="bg-gradient-yellow-orange rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="text-xl font-bold text-dil-purple mb-3">Get More Orders</h3>
                <p className="text-dil-purple mb-4">Simply reheat and assemble delivered food from us.</p>
                <div className="mt-auto h-48 w-full flex items-center justify-center">
                  <LazyImage
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Partnership Advantages</h2>
            ...
            {advantageCards.map((card, index) => (
              ...
              >
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-dil-purple mb-2">{card.title}</h3>
      ...
      <section id="calculator" className="py-16 md:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto">
            Fill in the details below to calculate how much potential your kitchen has to generate more orders and revenue.
          </p>
              ...
              <div className="mt-8 p-6 bg-gradient-purple-red rounded-lg text-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-2xl font-bold">{calculationResult.totalManHours}</p>
                  </div>
                  <div>
                    <p className="text-sm opacity-80">Total Potential Orders</p>
                    <p className="text-2xl font-bold">{calculationResult.totalPotentialOrders}</p>
                  </div>
                  <div>
                    <p className="text-sm opacity-80">Additional Orders Possible</p>
                    <p className="text-2xl font-bold">{calculationResult.additionalOrders}</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center justify-center border-t border-white/20 pt-4 mt-2">
                  ...
                  <p className="text-3xl font-bold">{calculationResult.underutilizedPercent}%</p>
                  
                  {calculationResult.recommendation && (
                    <div className="mt-4 p-3 bg-white/20 rounded-lg text-center">
                      <p className="font-bold text-xl">{calculationResult.recommendation}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                <div className="flex flex-col h-full">
                  <div className="mb-4">
                    <svg className="w-8 h-8 text-dil-yellow" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-white opacity-80">- {testimonial.author}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <form onSubmit={handleSubmit(onSignUpSubmit)} className="space-y-6">
            ...
            <div>
              ...
              {errors.restaurantName && (
                <p className="mt-1 text-sm text-red-600">Restaurant name is required</p>
              )}
            </div>
