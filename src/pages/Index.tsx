...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero Section */}
      <section id="hero" className="pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-16 animate-fadeInUp">
            ...
            <p className="text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
              Turning every kitchen of India into a bigger profit hub and powering fast deliveries through our in-house production
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 max-w-5xl mx-auto">
            <div className="bg-gradient-yellow-orange rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="p-6 md:p-8">
                <h3 className="text-2xl font-bold text-dil-purple mb-3">Restaurant Enabler</h3>
                <p className="text-dil-purple mb-6">Helping kitchens earn more profit from their existing infrastructure.</p>
                <div className="flex justify-between items-center">
                  ...
                  <img 
                    src="/lovable-uploads/1e31545b-5777-41d0-a858-3edfaab8f3d5.png" 
            ...
            <div className="bg-gradient-yellow-orange rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="p-6 md:p-8">
                <h3 className="text-2xl font-bold text-dil-purple mb-3">Food Qcom Enabler</h3>
                <p className="text-dil-purple mb-6">Empowering quick commerce with our ready-to-cook and ready-to-eat products.</p>
                <div className="flex justify-between items-center">
                  <Link 
                    to="/horeca-supply" 
                    className="inline-flex items-center bg-dil-purple text-white px-5 py-2.5 rounded-md font-semibold hover:bg-dil-purple/90 transition-all duration-300 shadow-md hover:shadow-lg"
                  ...
                  <img 
                    src="/lovable-uploads/98f6a237-3dd4-434e-94bf-b50be2ac7b35.png" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              Common goal: caring for the daily eating patterns of Indian consumers from various geographies, cultures, and ethnicities!
            </p>
          </div>
      ...
      {/* Fast Facts Section */}
      <section id="fast-facts" className="bg-gradient-purple-red py-16 md:py-20">
      ...
      <section id="cities" className="py-16 md:py-24 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Cities we serve</h2>
            <p className="text-gray-600">
              Currently live in 5 cities with plans to expand to 9 more locations soon
            </p>
          </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2 mb-8 md:mb-0">
              ...
              <p className="text-white/90 text-lg mb-6">
                We supply ready-to-cook and ready-to-eat products that regenerate in 2 minutes — perfect for 10-minute deliveries!
              </p>
              <Link
                to="/horeca-supply"
